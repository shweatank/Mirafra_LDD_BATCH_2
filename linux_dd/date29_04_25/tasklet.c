...
DECLARE_TASKSLET(my_tasklet, my_tasklet_func) ;


// Tasklet handler function with correct signature
static void my_tasklet_func(struct tasklet_struct *t){ pr_info ("Tasklet executed in SoftIRQ context. \n")};
